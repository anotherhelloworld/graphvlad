...
\paragraph{}
Для удобства использования структуры были написаны оператор "()" 
...
Соответственно для каждой вершины имеем следующую сумму сетевых расстояний:

\paragraph{}

Для первой вершины сумма сетевых расстояний будет состоять из сумм представленных ниже 
путей от первой вершины графа к остальным.
Далее через тире обозначены вершины графа и сумма весов всех ребер в данном пути:
\begin{gather}
1 - 3 : weight sum = 1 \\
1 - 3 - 4 : weight sum = 5 \\
...
Для второй вершины сумма сетевых расстояний будет состоять из сумм представленных ниже 
...
Для третьей вершины сумма сетевых расстояний будет состоять из сумм представленных ниже 
...
Для четвертой вершины сумма сетевых расстояний будет состоять из сумм представленных ниже 
...
Для пятой вершины сумма сетевых расстояний будет состоять из сумм представленных ниже 
...
Для шестой вершины сумма сетевых расстояний будет состоять из сумм представленных ниже 
...
Таким образом получим сумму сетевых расстояний в исходном графе $S = 20 + 20 + 16 + 16 + 20 + 20 = 112$.
...
В данном графе критическим является ребро между
